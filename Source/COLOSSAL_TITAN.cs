...
public class COLOSSAL_TITAN : Photon.MonoBehaviour
{
	...
	public void labelRPC(int health, int maxHealth, PhotonMessageInfo info)
	{
		...
		{
            Mod.NetworkHandler.HandleOperationResponse(info.sender, "Invalid labelRPC parameters");
            return;
		}
		if (health < 0)
		{
	...
	private void removeMe(PhotonMessageInfo info)
	{
		...
		{
            Mod.NetworkHandler.HandleOperationResponse(info.sender, "Invalid removeMe parameters");
			return;
        }
