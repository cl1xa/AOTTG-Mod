...
{
	public static IN_GAME_MAIN_CAMERA instance = new IN_GAME_MAIN_CAMERA();
	...
	//Modified
	//Removed check for chatroom alignment, recoded chatroom to be good and not require this extra check
